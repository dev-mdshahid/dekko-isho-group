      ...
      <div className="about-purpose-main">
        <div className="container">
          ...
          <div className="about-purpose-grid">
            <FadeIn id="about-purpose-values" className="about-purpose-card about-purpose-card--values">
              ...
              <ul className="about-purpose-values">
                {aboutCoreValues.map((value) => (
                  <li key={value.label} className="about-purpose-value-item">
                    ...
                    <span className="about-purpose-value-text">{value.description}</span>
                  </li>
                ))}
              </ul>
            </FadeIn>
            ...
            <div className="about-purpose-details">
              <FadeIn id="about-purpose-mission" className="about-purpose-card about-purpose-card--mission">
                <h3 className="about-purpose-block-title">Mission</h3>
                <p className="about-purpose-block-text">{aboutPurposeMission}</p>
              </FadeIn>

              <FadeIn id="about-purpose-vision" className="about-purpose-card about-purpose-card--vision">
