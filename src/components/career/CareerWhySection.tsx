...
export function CareerWhySection() {
  return (
    <section className="career-why-section section-spacing">
      <div className="career-content-container">
        <div className="career-why-main">
          <FadeIn id="career-why-header" className="career-why-header">
            ...
            <h2 className="section-title career-why-title">{careerWhy.heading}</h2>
          </FadeIn>
          ...
          <div className="career-why-list">
            {careerWhy.items.map((item, index) => (
              <FadeIn
                key={item.id}
                id={item.id}
                className="career-why-item"
                delay={index * 60}
              >
                <div className="career-why-number">{item.number}</div>
