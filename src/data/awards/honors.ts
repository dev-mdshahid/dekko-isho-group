...
export const awardsHonorsContent = {
  ...
  title: 'Awards & Honors',
  description:
    'Celebrating our achievements in innovation, quality, and sustainability that set industry standards.',
} as const
...
export const awardHonors: AwardHonor[] = [
  {
    ...
    imageAlt: 'Supplier Award — 2nd Place',
    title: 'Supplier Award — 2nd Place',
    category: 'camel active menswear',
    year: '2024',
  },
  {
    id: 'honor-best-pace-trainer',
    image: awardImage('best-pace-trainer.png'),
    imageAlt: 'Best P.A.C.E. Trainer',
    title: 'Best P.A.C.E. Trainer',
    category: 'Thrive Champions Award',
    year: '2024',
  },
  {
    id: 'honor-highest-pace-learners',
    image: awardImage('highest-pace-learners.png'),
    imageAlt: 'Highest P.A.C.E. Learners — 2nd Runner Up',
  ...
  },
  {
    ...
    imageAlt: 'Certificate of Excellence — Dekko Garments',
    title: 'Certificate of Excellence',
    category: 'Thrive Champions · Dekko Garments',
    year: '2024',
  },
  {
    id: 'honor-certificate-excellence-thrive-2',
    image: awardImage('28fd16e88849bad1549dac6e8940a4f90ca0bd8a.png'),
    imageAlt: 'Certificate of Excellence — Dekko Fashions',
    title: 'Certificate of Excellence',
    category: 'Thrive Champions · Dekko Fashions',
    year: '2024',
  },
  {
    ...
    category: 'VARNER · Top Hard Value Score',
    year: '2023',
  },
  {
    id: 'honor-kiabi-supplier-relationship',
    image: awardImage('kiabi-supplier-relationship.png'),
    imageAlt: 'KIABI Supplier Relationship Management Day',
  ...
  },
  {
    ...
    imageAlt: 'Jack&Jones Leading Manufacturer Growth Turnover',
  ...
  {
    id: 'honor-certificate-excellence-supplier-2024',
...
/** Gallery shelves — column count follows each shelf length (designer Layout A). */
export const awardHonorShelves: AwardHonor[][] = [
  awardHonors.slice(0, 4),
  awardHonors.slice(4, 8),
  awardHonors.slice(8),
]
