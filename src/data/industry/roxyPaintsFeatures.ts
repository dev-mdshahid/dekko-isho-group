...
export const roxyPaintsFeatures: IndustryFeaturesProps = {
  badge: 'Paint Manufacturing',
  title: 'A Legacy Brand Coloring Homes, Industries, and Infrastructure.',
  descriptions: [
    ...
    'Quality is never an ending journey. Making sure strong foothold in this dynamic global market, Roxy has invested vigorously for its exclusive and modern R & D unit dedicating itself equally at laboratory, plant and customer level to ensure constant quest for quality improvement and research into its present and future product configuration and presentations. The proverbial “old is gold” concept is only meaningful if the future looks brighter and consistent with the past.',
    'Roxy\u2019s future expansion master plan includes establishing its own backward linkage project for producing time tested quality as well as developing new paint formulations to meet customer\u2019s satisfaction.',
  ],
